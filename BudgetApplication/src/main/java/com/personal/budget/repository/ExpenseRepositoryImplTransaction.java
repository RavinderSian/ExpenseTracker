...
@Repository
public class ExpenseRepositoryImplTransaction {

	private final JdbcTemplate jdbcTemplate;
	
	public ExpenseRepositoryImplTransaction(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}
	
	@Transactional(rollbackFor = { SQLException.class })
	public void updateExpenseTransaction (Expense expense) throws SQLException {
		jdbcTemplate.update("UPDATE expenses SET category = ?, amount = ?, description = ?, "
				+ "purchase_date = ? WHERE id = ?;", 
				expense.getCategory(), expense.getAmount(), expense.getDescription(), 
				expense.getPurchaseDate(), expense.getId());
